package com.tingyu.tongmeng.edu.service.order.test;
...
public class MybatisPlusGenerator {
    ...
    private static final String homePath = "D:\\Development\\WorkSpace\\IdeaProjects\\tongmeng-edu\\tongmeng-edu-service\\tongmeng-edu-service-order\\src\\main\\java";
    ...
    public static void main(String[] args) {
        ...
        strategy.setTablePrefix( "edu_");//生成实体时，去掉表前缀
